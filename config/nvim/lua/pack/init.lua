    ...
    },
    {
        ...
        opts = {
            ...
            on_attach = function (bufnr)
                ...
                nnoremap(']g', gs.nav_hunk, 'next', { greedy = false })
                nnoremap('[g', gs.nav_hunk, 'prev', { greedy = false })
                nnoremap(']G', gs.nav_hunk, 'next', { greedy = false, target = 'staged' })
                nnoremap('[G', gs.nav_hunk, 'prev', { greedy = false, target = 'staged' })
